...
class Dongle(wx.Panel):
    def __init__(self, parent):
        ...
        bluetoothName = wx.StaticText(self,-1,"bluetooth add")
        infosBtn = wx.Button(self,label = "Infos")
        options = ["enabled","disabled"]
        comboBox = wx.ComboBox(self, choices = options)
        configBtn = wx.Button(self,label = "Config")

        hbox1.Add(bluetoothName,proportion=2,flag=wx.ALL,border=10)
        hbox1.Add(infosBtn,proportion=0, flag=wx.ALL | wx.EXPAND, border=10)
        hbox1.Add(comboBox, proportion = 0, flag=wx.ALL | wx.EXPAND,border=10)
        hbox1.Add(configBtn, proportion = 0, flag=wx.ALL | wx.EXPAND,border=10)
